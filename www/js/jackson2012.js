...
$(document).ready(function () {
    ...
    function disableButtons(counter_max, counter_current) {
        $("#previous-print, #next-print").show();
    ...
    function loadGallery(setIDs, setClickAttr) {
        ...
        $("#next-print, #previous-print").click(function () {
            if ($(this).attr("id") === "previous-print") {
                current_image--;
            } else {
                current_image++;
            }
        ...
        function updateGallery(selector) {
            ...
            $("#gallery-image").attr("src", $sel.data("image"));
    ...
    switch (e.which) {
        case 37: // left
            if (
                ...
                $("#previous-print").is(":visible")
            ) {
                $("#previous-print").click();
            }
            break;
